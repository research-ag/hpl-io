import {
  ...
  v2ResponseBody,
  v3ResponseBody,
} from '@dfinity/agent/lib/cjs/agent';
import { AgentError } from '@dfinity/agent/lib/cjs/errors';
import { bufFromBufLike, IDL } from '@dfinity/candid';
import { pollForResponse, PollStrategyFactory, strategy } from '@dfinity/agent/lib/cjs/polling';
import { Principal } from '@dfinity/principal';
import { RequestId } from '@dfinity/agent/lib/cjs/request_id';
import { toHex } from '@dfinity/agent/lib/cjs/utils/buffer';
import { Certificate, CreateCertificateOptions, lookupResultToBuffer } from '@dfinity/agent/lib/cjs/certificate';
import managementCanisterIdl from '@dfinity/agent/lib/cjs/canisters/management_idl';
import _SERVICE, {
...
export class Actor {
  ...
  public static async createCanister(config?: CallConfig, settings?: CreateCanisterSettings): Promise<Principal> {
  ...
  public static createActorWithExtendedDetails<T = Record<string, ActorMethod>>(
    ...
    return new (this.createActorClass(interfaceFactory, actorClassOptions))(configuration) as unknown as ActorSubclass<
      ActorMethodMappedExtended<T>
    >;
  }
