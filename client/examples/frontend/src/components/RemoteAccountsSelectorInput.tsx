      ...
      {inputValues.map((tuple, index) => (
        <div key={index}
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {(index === 0) && <span><b>Account holder:</b></span>}
            <input
              type='text'
              value={tuple[0]}
              onChange={(e) => {
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {(index === 0) && <span><b>Account id:</b></span>}
            <IdSelectorInput value={tuple[1]} onOutputChange={(selector) => {
              const updatedValues = [...inputValues];
